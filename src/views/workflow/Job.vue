<template
  ...
  xmlns:v="http://www.w3.org/1999/XSL/Transform"
>
  <div>
      ...
      >
        <template v-slot:items="props">
          ...
          <td class="justify-center layout px-0">
            <v-tooltip
              v-if="(permitRule['JobAuthorized'] & props.item['permit']) > 0"
              top
            >
            ...
            <v-tooltip
              v-if="(permitRule['JobEdit'] & props.item['permit']) > 0"
              top
            >
              <template v-slot:activator="{ on }">
                <v-icon
            ...
            <v-tooltip
              v-if="(permitRule['JobDelete'] & props.item['permit']) > 0"
              top
            >
              <template v-slot:activator="{ on }">
